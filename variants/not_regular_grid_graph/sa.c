	     ...
	     const int low_length, const int groups, const int *rotate_hash, const bool enable_fixed_temp)
{
  ...
  create_adjacency(nodes, lines, max_degree, (const int (*)[2])edge, adjacency, degree);
  ...
  for(ii=0;ii<ncalcs;ii++){
    ...
    while(1){
      ...
      create_adjacency(nodes, lines, max_degree, (const int (*)[2])tmp_edge, adjacency, degree);
...
double estimated_elapse_time(const int nodes, const int lines, const int max_degree, const int edge[lines*2],
			     const int height, const int width, const int based_height, const int groups,
			     const int low_length, const bool enable_bfs, const int *rotate_hash, int *degree)
{
...
void check_current_edge(const int nodes, const int lines, const int max_degree, const int edge[lines*2],
			const double low_ASPL, const int low_diam, const int groups, const int height,
			const int based_height,	const bool enable_bfs, const int *rotate_hash, int *degree)
{
  int based_nodes = nodes / groups;
  int diam;
  double ASPL;
