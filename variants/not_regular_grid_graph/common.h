...
extern void check_current_edge(const int nodes, const int lines, const int max_degree, const int edge[lines*2], const double low_ASPL, const int low_diam,
			       const int groups, const int height, const int based_height, const bool enable_bfs, const int *rotate_hash, int *degree);
extern double estimated_elapse_time(const int nodes, const int lines, const int max_degree, const int edge[lines*2],
				    const int height, const int width, const int based_height,
				    const int groups, const int low_length, const bool enable_bfs, const int *rotate_hash, int *degree);
...
extern void create_adjacency(const int nodes, const int lines, const int max_degree, 
                             const int edge[lines][2], int adjacency[nodes][max_degree], int *degree);
...
extern void exchange_edge(const int nodes, const int lines, int edge[lines][2],
...
extern bool IS_EDGE(const int e);
extern void REVERSE(int *e);
