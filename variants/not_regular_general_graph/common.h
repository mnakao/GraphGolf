...
extern long long sa(const int nodes, const int lines, const int degree, const int groups,
		    ...
		    const int added_centers, const int based_nodes, long long *num_accepts, const bool is_simple_graph,
		    const int num_degrees[nodes], const int algo);
...
extern bool evaluation(const int nodes, const int based_nodes, const int groups, const int lines, const int degree, 
		       int* restrict adj, int* restrict diameter, double* restrict ASPL, const int added_centers,
		       const int num_degrees[nodes], const int algo);
